...
_("{n} found")
_("{n} highlights")
_("{n} highlights assigned to this device will become Unknown device.")
_("{n} highlights were made on this device. They are not deleted. Their origin history is kept.")
