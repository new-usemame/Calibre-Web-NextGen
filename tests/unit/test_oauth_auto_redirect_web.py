...
def _oauth_only_patches(*, spa_preferred=False):
    return (
...
def test_login_route_starts_provider_and_forwards_relative_next():
    ...
    p1, p2, p3, p4, p5 = _oauth_only_patches()
    with p1, p2, p3, p4, p5:
...
def test_local_parameter_falls_through_to_spa_preference():
    app = _app()
    p1, p2, p3, p4, p5 = _oauth_only_patches(spa_preferred=True)
...
def test_local_parameter_falls_through_to_classic_login():
    ...
    p1, p2, p3, p4, p5 = _oauth_only_patches(spa_preferred=False)
    with p1, p2, p3, p4, p5, \
