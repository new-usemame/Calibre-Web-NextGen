...
At this revision the derived set is 176 of 236 local Python modules (the closure correctly picks
...
`cps/services/koreader_xpointer.py` entered through the annotation routes that call it. It also now picks up the cover picker and
