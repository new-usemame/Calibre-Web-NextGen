...
At this revision the derived set is 150 of 217 local Python modules (this branch adds `cps/user_library.py`, which the closure correctly picks up — membership is queried on the request path). Measured at `origin/main`
